...
Info  : https://brightdata.jp/products/insights/price-tracker/just-eat
"""
...
# https://brightdata.jp/products/web-scraper/just-eat
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Just Eat scraper at: https://brightdata.jp/products/web-scraper/just-eat\n"
